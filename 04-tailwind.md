...
This document covers Tailwind CSS, a utility-first CSS framework for rapidly building custom designs. Topics include installation and configuration, core concepts (utility classes, responsive prefixes, state variants), layout and spacing, Flexbox and Grid utilities, typography, backgrounds and effects, transitions and animations, component building patterns, and customization through the configuration file.

## Sommaire

- [1. Introduction](#1-introduction)
  - [What is Tailwind CSS?](#what-is-tailwind-css)
  - [Introduction UML: Tailwind CSS Architecture](#introduction-uml-tailwind-css-architecture)
...
- [2. Installation & Setup](#2-installation-&-setup)
  ...
  - [CDN (Quick Start - Development Only)](#cdn-quick-start---development-only)
  - [NPM Installation (Production)](#npm-installation-production)
  - [Initialize Tailwind](#initialize-tailwind)
  - [Configure Content (tailwind.config.js)](#configure-content-tailwindconfigjs)
  - [Create CSS Entry File](#create-css-entry-file)
  - [Build Process](#build-process)
  - [VS Code Extensions](#vs-code-extensions)
  - [Framework Integration](#framework-integration)
- [3. Core Concepts](#3-core-concepts)
  - [Utility-First Workflow Diagram](#utility-first-workflow-diagram)
  - [Utility Classes](#utility-classes)
  - [Responsive Prefixes (Mobile-First)](#responsive-prefixes-mobile-first)
...
- [6. Typography](#6-typography)
  ...
  - [Text Decoration & Transform](#text-decoration-&-transform)
  - [Text Overflow & Truncation](#text-overflow-&-truncation)
  - [Complete Typography Examples](#complete-typography-examples)
- [7. Backgrounds, Borders & Effects](#7-backgrounds-borders-&-effects)
  - [Background Color](#background-color)
  - [Background Gradients](#background-gradients)
  - [Background Size, Position & Repeat](#background-size-position-&-repeat)
  - [Border Width & Style](#border-width-&-style)
...
- [9. Transitions & Animations](#9-transitions-&-animations)
  ...
  - [Duration](#duration)
  - [Timing Function (Easing)](#timing-function-easing)
  - [Delay](#delay)
  - [Transform (Scale, Rotate, Translate)](#transform-scale-rotate-translate)
  - [Built-in Animations](#built-in-animations)
  - [Custom Animations](#custom-animations)
  - [Animation Examples](#animation-examples)
- [10. Building Components](#10-building-components)
  - [Buttons](#buttons)
  - [Cards](#cards)
...
- [11. Customization](#11-customization)
  ...
  - [Adding Utilities with @layer](#adding-utilities-with-@layer)
  - [Custom Variants](#custom-variants)
- [12. Plugins & Best Practices](#12-plugins-&-best-practices)
  - [Official Plugins](#official-plugins)
  - [Community Plugins (Popular)](#community-plugins-popular)
  - [When to Extract Components](#when-to-extract-components)
  - [Organizing Classes](#organizing-classes)
  - [Best Practices Summary](#best-practices-summary)
- [Quick Reference](#quick-reference)
  - [Common Class Combinations](#common-class-combinations)
  - [Responsive Breakpoint Cheat Sheet](#responsive-breakpoint-cheat-sheet)
